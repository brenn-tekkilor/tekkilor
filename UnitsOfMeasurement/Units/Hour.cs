...
namespace UnitsOfMeasurement
{
    public partial struct Hour : IQuantity<double>, IEquatable<Hour>, IComparable<Hour>, IFormattable
    {
        ...
        public static explicit operator Hour(Day q) { return new Hour((Hour.Factor / Day.Factor) * q.m_value); }
        public static explicit operator Hour(Year q) { return new Hour((Hour.Factor / Year.Factor) * q.m_value); }
        public static explicit operator Hour(Month q) { return new Hour((Hour.Factor / Month.Factor) * q.m_value); }
        public static explicit operator Hour(Week q) { return new Hour((Hour.Factor / Week.Factor) * q.m_value); }
