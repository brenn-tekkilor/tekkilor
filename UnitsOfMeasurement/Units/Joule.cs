...
namespace UnitsOfMeasurement
{
    public partial struct Joule : IQuantity<double>, IEquatable<Joule>, IComparable<Joule>, IFormattable
    {
        ...
        public static explicit operator Joule(BTU q) { return new Joule((Joule.Factor / BTU.Factor) * q.m_value); }
        public static explicit operator Joule(Calorie q) { return new Joule((Joule.Factor / Calorie.Factor) * q.m_value); }
