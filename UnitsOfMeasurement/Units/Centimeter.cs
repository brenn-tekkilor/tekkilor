...
namespace UnitsOfMeasurement
{
    public partial struct Centimeter : IQuantity<double>, IEquatable<Centimeter>, IComparable<Centimeter>, IFormattable
    {
        ...
        public static explicit operator Centimeter(Point q) { return new Centimeter((Centimeter.Factor / Point.Factor) * q.m_value); }
        public static explicit operator Centimeter(Pica q) { return new Centimeter((Centimeter.Factor / Pica.Factor) * q.m_value); }
        ...
        // Outer:
        public static SquareCentimeter operator *(Centimeter lhs, Centimeter rhs) { return new SquareCentimeter(lhs.m_value * rhs.m_value); }
        #endregion
