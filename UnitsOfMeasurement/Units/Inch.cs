...
namespace UnitsOfMeasurement
{
    public partial struct Inch : IQuantity<double>, IEquatable<Inch>, IComparable<Inch>, IFormattable
    {
        ...
        public static explicit operator Inch(Point q) { return new Inch((Inch.Factor / Point.Factor) * q.m_value); }
        public static explicit operator Inch(Pica q) { return new Inch((Inch.Factor / Pica.Factor) * q.m_value); }
        ...
        // Outer:
        public static SquareInch operator *(Inch lhs, Inch rhs) { return new SquareInch(lhs.m_value * rhs.m_value); }
        #endregion
