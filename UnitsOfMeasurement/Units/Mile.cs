...
namespace UnitsOfMeasurement
{
    public partial struct Mile : IQuantity<double>, IEquatable<Mile>, IComparable<Mile>, IFormattable
    {
        ...
        public static explicit operator Mile(Point q) { return new Mile((Mile.Factor / Point.Factor) * q.m_value); }
        public static explicit operator Mile(Pica q) { return new Mile((Mile.Factor / Pica.Factor) * q.m_value); }
        ...
        // Outer:
        public static SquareMile operator *(Mile lhs, Mile rhs) { return new SquareMile(lhs.m_value * rhs.m_value); }
