...
namespace UnitsOfMeasurement
{
    public partial struct SquareMeter : IQuantity<double>, IEquatable<SquareMeter>, IComparable<SquareMeter>, IFormattable
    {
        ...
        public static explicit operator SquareMeter(SquareMile q) { return new SquareMeter((SquareMeter.Factor / SquareMile.Factor) * q.m_value); }
        public static explicit operator SquareMeter(SquareYard q) { return new SquareMeter((SquareMeter.Factor / SquareYard.Factor) * q.m_value); }
        ...
        public static explicit operator SquareMeter(SquareInch q) { return new SquareMeter((SquareMeter.Factor / SquareInch.Factor) * q.m_value); }
        public static explicit operator SquareMeter(SquareCentimeter q) { return new SquareMeter((SquareMeter.Factor / SquareCentimeter.Factor) * q.m_value); }
