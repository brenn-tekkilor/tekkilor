...
namespace UnitsOfMeasurement
{
    public partial struct SquareFoot : IQuantity<double>, IEquatable<SquareFoot>, IComparable<SquareFoot>, IFormattable
    {
        ...
        public static explicit operator SquareFoot(SquareInch q) { return new SquareFoot((SquareFoot.Factor / SquareInch.Factor) * q.m_value); }
        public static explicit operator SquareFoot(SquareCentimeter q) { return new SquareFoot((SquareFoot.Factor / SquareCentimeter.Factor) * q.m_value); }
        ...
        public static explicit operator SquareFoot(SquareMile q) { return new SquareFoot((SquareFoot.Factor / SquareMile.Factor) * q.m_value); }
        public static explicit operator SquareFoot(SquareYard q) { return new SquareFoot((SquareFoot.Factor / SquareYard.Factor) * q.m_value); }
        ...
        public static CubicFoot operator *(SquareFoot lhs, Foot rhs) { return new CubicFoot(lhs.m_value * rhs.m_value); }
        public static CubicFoot operator *(Foot lhs, SquareFoot rhs) { return new CubicFoot(lhs.m_value * rhs.m_value); }
        #endregion
