...
namespace UnitsOfMeasurement
{
    public partial struct Watt : IQuantity<double>, IEquatable<Watt>, IComparable<Watt>, IFormattable
    {
        ...
        public static explicit operator Watt(BTU_Hour q) { return new Watt((Watt.Factor / BTU_Hour.Factor) * q.m_value); }
        public static explicit operator Watt(KiloWatt q) { return new Watt((Watt.Factor / KiloWatt.Factor) * q.m_value); }
