...
namespace UnitsOfMeasurement
{
    public partial struct Second : IQuantity<double>, IEquatable<Second>, IComparable<Second>, IFormattable
    {
        ...
        public static explicit operator Second(Day q) { return new Second((Second.Factor / Day.Factor) * q.m_value); }
        public static explicit operator Second(Year q) { return new Second((Second.Factor / Year.Factor) * q.m_value); }
        public static explicit operator Second(Month q) { return new Second((Second.Factor / Month.Factor) * q.m_value); }
        public static explicit operator Second(Week q) { return new Second((Second.Factor / Week.Factor) * q.m_value); }
