...
namespace UnitsOfMeasurement
{
    public partial struct CubicMeter : IQuantity<double>, IEquatable<CubicMeter>, IComparable<CubicMeter>, IFormattable
    {
        ...
        public static explicit operator CubicMeter(CubicYard q) { return new CubicMeter((CubicMeter.Factor / CubicYard.Factor) * q.m_value); }
        public static explicit operator CubicMeter(CubicFoot q) { return new CubicMeter((CubicMeter.Factor / CubicFoot.Factor) * q.m_value); }
        public static explicit operator CubicMeter(CubicInch q) { return new CubicMeter((CubicMeter.Factor / CubicInch.Factor) * q.m_value); }
        public static explicit operator CubicMeter(Liter q) { return new CubicMeter((CubicMeter.Factor / Liter.Factor) * q.m_value); }
        public static explicit operator CubicMeter(CubicCentimeter q) { return new CubicMeter((CubicMeter.Factor / CubicCentimeter.Factor) * q.m_value); }
