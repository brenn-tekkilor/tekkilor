...
namespace UnitsOfMeasurement
{
    public partial struct Minute : IQuantity<double>, IEquatable<Minute>, IComparable<Minute>, IFormattable
    {
        ...
        public static explicit operator Minute(Day q) { return new Minute((Minute.Factor / Day.Factor) * q.m_value); }
        public static explicit operator Minute(Year q) { return new Minute((Minute.Factor / Year.Factor) * q.m_value); }
        public static explicit operator Minute(Month q) { return new Minute((Minute.Factor / Month.Factor) * q.m_value); }
        public static explicit operator Minute(Week q) { return new Minute((Minute.Factor / Week.Factor) * q.m_value); }
