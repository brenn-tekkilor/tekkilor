...
namespace UnitsOfMeasurement
{
    public partial struct Millimeter : IQuantity<double>, IEquatable<Millimeter>, IComparable<Millimeter>, IFormattable
    {
        ...
        public static explicit operator Millimeter(Point q) { return new Millimeter((Millimeter.Factor / Point.Factor) * q.m_value); }
        public static explicit operator Millimeter(Pica q) { return new Millimeter((Millimeter.Factor / Pica.Factor) * q.m_value); }
