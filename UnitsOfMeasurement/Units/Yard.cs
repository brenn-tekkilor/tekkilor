...
namespace UnitsOfMeasurement
{
    public partial struct Yard : IQuantity<double>, IEquatable<Yard>, IComparable<Yard>, IFormattable
    {
        ...
        public static explicit operator Yard(Point q) { return new Yard((Yard.Factor / Point.Factor) * q.m_value); }
        public static explicit operator Yard(Pica q) { return new Yard((Yard.Factor / Pica.Factor) * q.m_value); }
        ...
        // Outer:
        public static SquareYard operator *(Yard lhs, Yard rhs) { return new SquareYard(lhs.m_value * rhs.m_value); }
        #endregion
