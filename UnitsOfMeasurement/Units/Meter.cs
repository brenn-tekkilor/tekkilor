...
namespace UnitsOfMeasurement
{
    public partial struct Meter : IQuantity<double>, IEquatable<Meter>, IComparable<Meter>, IFormattable
    {
        ...
        public static explicit operator Meter(Point q) { return new Meter((Meter.Factor / Point.Factor) * q.m_value); }
        public static explicit operator Meter(Pica q) { return new Meter((Meter.Factor / Pica.Factor) * q.m_value); }
